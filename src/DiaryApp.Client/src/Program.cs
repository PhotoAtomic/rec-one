...
// In Blazor WebAssembly, cookies are automatically included for same-origin requests
// The default HttpClient configuration is sufficient for cookie-based authentication
